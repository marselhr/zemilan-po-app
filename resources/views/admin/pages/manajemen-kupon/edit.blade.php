        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
                <div class="mb-3 mb-md-0">
                    <h1 class="mb-1 h2 fw-bold">Edit Data Kupon</h1>
                    <!-- Breadcrumb -->
            ...
            <div class="d-flex flex-wrap col-12">
                ...
                <div class="px-2 col-12 col-md-6  col-xl-4">
                    <div class="mb-3 ">
                        ...
                        <input name="code" type="text" id="codeInput" class="form-control"
                            placeholder="cth. KUPON-PEDAS" value="{{ old('code') ?? $coupon->code }}">
                    </div>
                </div>
                <!-- Select Option -->
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    ...
                    <div class="mb-3 ">
                        ...
                        <select class="form-select" name="type" id="typeCoupon">
                            <option selected>--> Pilih Tipe <-- </option>
                            <option value="fixed"
                                {{ old('type') == 'fixed' || $coupon->type == 'fixed' ? 'selected' : '' }}>Fixed</option>
                            <option value="percent"
                                {{ old('type') == 'percent' || $coupon->type == 'percent' ? 'selected' : '' }}>Percent
                            </option>
                        </select>
                    </div>
                </div>
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input name="value" value="{{ old('value') ?? $coupon->value }}" type="text" id="valueInput"
                            class="form-control" placeholder="cth. 100">
                    </div>
                </div>
                ...
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="max_uses_user" type="number" id="codeInput" class="form-control"
                            placeholder="jumlah klaim oleh satu user"
                            value="{{ old('max_uses_us
                                                                                                                                                                                                                                                                                                                                                er') ??
                ...
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input name="max_uses" type="number" id="codeInput" class="form-control" placeholder="total kupon"
                ...
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control flatpickr flatpickr-input" name="start_date"
                            placeholder="" value="{{ old('start_date') ?? $coupon->start_date }}">
                    </div>
                </div>
                <div class="px-2 col-12 col-md-6 col-xl-4">
                    <div class="mb-3">
                        <label class="form-label" for="expirationInput">Kadaluarsa Kupon</label>
                        <input type="text" class="form-control flatpickr flatpickr-input" name="expiration_date"
                            placeholder="" value="{{ old('expiration_date') ?? $coupon->expiration_date }}">
                    </div>
                </div>
